...
- Base release is v214 / 3.9.137, not the historical v200 snapshot. Latest authoritative task history is memory.md Round 66.
...
- Verification checkpoint: 41/41 cases / 1700 assertions; local gates green; 11 new E2EE policy, 8 attachment-exit and 9 preview formatter JVM tests. CI for items 1 and 2 is green; item 3/release CI follows. See memory.md for live probe evidence and IDs, not the historical deployment table above.
