...
check(
  "r75-9: versionCode 218 / versionName 3.9.141 (the hold-era dev bumps; the release policy says the next release must be > 215)",
  /versionCode\s*=\s*218\b/.test(pkg) && /versionName\s*=\s*"3\.9\.141"/.test(pkg),
);
