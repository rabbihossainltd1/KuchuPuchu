...
check(
  "r75-8: versionCode 217 / versionName 3.9.140 (the hold-era dev bumps; the release policy says the next release must be > 215)",
  /versionCode\s*=\s*217\b/.test(pkg) && /versionName\s*=\s*"3\.9\.140"/.test(pkg),
);
