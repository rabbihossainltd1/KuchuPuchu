...
check(
  "r76-4: versionCode 221 / versionName 3.9.144 (window-level recorder overlay; the build says its own name; release policy still > 215)",
  /versionCode\s*=\s*221\b/.test(pkg) && /versionName\s*=\s*"3\.9\.144"/.test(pkg),
);
