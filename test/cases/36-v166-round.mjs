...
check(
  "r75-7: versionCode 216 / versionName 3.9.139 (the hold-era dev bumps; the release policy says the next release must be > 215)",
  /versionCode\s*=\s*216\b/.test(pkg) && /versionName\s*=\s*"3\.9\.139"/.test(pkg),
);
